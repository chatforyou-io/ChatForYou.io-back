...
public class ConnectionProperties {
	...
	/**
	 *
	 * Builder for {@link ConnectionProperties}
	 *
	 */
	public static class Builder {
		 ...
		 * {@link ConnectionType} dictates what properties will
		 * have effect:
		 * <ul>
		 * <li>{@link ConnectionType#WEBRTC}:
		 * {@link Builder#data(String)
		 * data},
		 * {@link Builder#record(boolean)
		 * record},
		 * {@link Builder#role(OpenViduRole)
		 * role},
		 * {@link Builder#kurentoOptions(KurentoOptions)
		 * kurentoOptions}</li>
		 * <li>{@link ConnectionType#IPCAM}:
		 * {@link Builder#data(String)
		 * data},
		 * {@link Builder#record(boolean)
		 * record},
		 * {@link Builder#rtspUri(String)
		 * rtspUri},
		 * {@link Builder#adaptativeBitrate(boolean)
		 * adaptativeBitrate},
		 * {@link Builder#onlyPlayWithSubscribers(boolean)
		 * onlyPlayWithSubscribers},
		 * {@link Builder#networkCache(int)
		 * networkCache}</li>
		 * </ul>
		 * If not set by default will be
		 * {@link ConnectionType#WEBRTC}.
		 */
		 ...
		 * default will be {@link OpenViduRole#PUBLISHER
		 * PUBLISHER}.
		 *
		 * <br>
		 * <br>
		 * <strong>Only for
		 * {@link ConnectionType#WEBRTC}</strong>
		 */
		...
		/**
		 * Call this method to set a {@link KurentoOptions}
		 ...
		 * <br>
		 * <strong>Only for
		 * {@link ConnectionType#IPCAM}</strong>
		 * 
		 ...
		 * {@link ConnectionProperties#customIceServers
	 ...
	 * <br>
	 * See
	 * {@link Builder#addCustomIceServer(IceServerProperties)}
	...
	/**
	 * Obtain a {@link Builder} directly from a JSON object in
	 * the form of a Map
	 * 
