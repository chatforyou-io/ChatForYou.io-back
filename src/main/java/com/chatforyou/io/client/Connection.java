...
/**
 * See {@link Session#getConnections()}
 */
public class Connection {
	 ...
	 * {@link Session#forceDisconnect(String)} or
	 ...
	 * is set with {@link TokenOptions.Builder#data(String)}
	 * when calling {@link Session#generateToken()}
	 */
	 ...
	 * <br><br>
	 * See {@link ConnectionProperties.Builder#addCustomIceServer(IceServerProperties)} for more
	 * information.
	 * <br><br>
	 * <strong>Only for
	 * {@link ConnectionType#WEBRTC}</strong>
	 ...
	 * {@link Session#forceUnpublish(Publisher)} passing any
