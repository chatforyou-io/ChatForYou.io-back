...
public class Session {
	 ...
	 *             instead to get a {@link Connection}
	 *             object.
	 *
	 ...
	 *
	 * @return The generated {@link Connection Connection}
	 *         object.
	 *
	 * @throws OpenViduJavaClientException
	 * @throws OpenViduHttpException
	 ...
	 * be retrieved with {@link Connection#getToken()
	 * Connection.getToken()}.
	 *
	 * @return The generated {@link Connection Connection}
	 *         object.
	 ...
	 * ({@link Session#getActiveConnections()}) and use
	 * those values to call
	 * {@link Session#forceDisconnect(Connection)},
	 * {@link Session#forceUnpublish(Publisher)} or
	 * {@link Session#updateConnection(String, ConnectionProperties)}.<br>
	 * <br>
	 *
	 ...
	 * {@link Session#fetch() Session.fetch()} or
	 * {@link OpenVidu#fetch() OpenVidu.fetch()} to see the
	...
	/**
	 * Same as {@link Session#forceDisconnect(Connection)
	 * forceDisconnect(ConnectionProperties)} but providing the
	 * {@link Connection#getConnectionId() connectionId}
	 ...
	 * {@link Session#getActiveConnections()} and then for
	 * each Connection you can call
	 * {@link Connection#getPublishers()}. Remember to call
	 * {@link Session#fetch()} before to fetch the current
	...
	/**
	 * Same as {@link Session#forceUnpublish(Publisher)
	 * forceUnpublish(Publisher)} but providing the
	 * {@link Publisher#getStreamId() streamId} instead of
	 ...
	 * {@link ConnectionProperties} object. Only these
	 * properties can be updated:
	 * <ul>
	 * <li>{@link ConnectionProperties.Builder#role(OpenViduRole)
	 * ConnectionProperties.Builder.role(OpenViduRole)}</li>
	 * <li>{@link ConnectionProperties.Builder#record(boolean)
	 ...
	 *                             to apply
	 *
	 * @return The updated {@link Connection Connection}
	 *         object
	 *
	 * @throws OpenViduJavaClientException
	 * @throws OpenViduHttpException
	 ...
	 * {@link Session#fetch() Session.fetch()} or
	 * {@link OpenVidu#fetch() OpenVidu.fetch()}.
	 *
	 * @param id The Connection to get
	 *
	 * @return The {@link Connection Connection} object, or
	 ...
	 * method {@link Session#fetch() Session.fetch()} or
	 * {@link OpenVidu#fetch() OpenVidu.fetch()} was
	 ...
	 * <li>Calling {@link Session#forceUnpublish(String)}
	 * automatically updates each affected local Connection object.</li>
	 * <li>Calling {@link Session#forceDisconnect(String)}
	 * automatically updates each affected local Connection object.</li>
	 * <li>Calling
	 * {@link Session#updateConnection(String, ConnectionProperties)}
	 ...
	 * first {@link Session#fetch() Session.fetch()} or
	 * {@link OpenVidu#fetch() OpenVidu.fetch()}.
	 */
	 ...
	 * {@link Connection#getStatus()}. This method only
	 ...
	 * time method {@link Session#fetch() Session.fetch()}
	 * or {@link OpenVidu#fetch() OpenVidu.fetch()} was
	 * called</strong>. Exceptions to this rule are:
	 * <ul>
	 * <li>Calling
	 * {@link Session#createConnection(ConnectionProperties)
	 ...
	 * must call first {@link Session#fetch()
	 * Session.fetch()} or {@link OpenVidu#fetch()
	 * OpenVidu.fetch()}.
	 */
	...
	protected Session resetWithJson(JsonObject json) {
		...
		if (JsonUtils.getStrOrNull(json, "recording") != null) {
			this.recording = json.get("recording").getAsBoolean();
		}

		if (JsonUtils.getStrOrNull(json, "broadcasting") != null) {
