...
public class OpenVidu {
	 ...
	 * {@link Recording.Status#stopped},
	 * {@link Recording.Status#ready} or
	 * {@link Recording.Status#failed}
	 *
	 ...
	 * since the last time method {@link OpenVidu#fetch()}
	 * was called</strong>. Exceptions to this rule are:
	 * <ul>
	 * <li>Calling
	 * {@link OpenVidu#createSession(SessionProperties)
	 * OpenVidu.createSession} automatically adds the new Session object to the
	 * local collection.</li>
	 * <li>Calling {@link Session#fetch()} updates that
	 * specific Session status</li>
	 * <li>Calling {@link Session#close()} automatically
	 ...
	 * Session</li>
	 * <li>Calling {@link Session#forceUnpublish(Publisher)}
	 * automatically updates the inner affected connections for that specific
	 * Session</li>
	 * <li>Calling
	 ...
	 * Session</li>
	 * <li>Calling {@link OpenVidu#startRecording(String)}
	 * and {@link OpenVidu#stopRecording(String)}
	 * automatically updates the recording status of the Session
	 * ({@link Session#isBeingRecorded()})</li>
	 * </ul>
	 * <br>
	 * To get the list of active sessions with their current actual value, you must
	 * call first {@link OpenVidu#fetch()} and then
	 * {@link OpenVidu#getActiveSessions()}
	 */
	 ...
	 * as {@link OpenVidu#getActiveSessions()}, but it just
